...
export function toShareClassValue(x: RemoteValuationShareClassValue): PortfolioValuationReportShareClassValue {
  return {
    ...
    external: x.external
      ? {
          id: x.external.id,
          created: x.external.created,
          creator: Maybe.fromNullable(x.external.updater),
          updated: x.external.updated,
          updater: Maybe.fromNullable(x.external.updater),
          guid: x.external.guid,
          portfolio: x.external.portfolio,
          shareclass: Maybe.fromNullable(x.external.shareclass),
          date: x.external.date,
          ccy: x.external.ccy,
          shares: decimalFromNullable(x.external.shares),
          price: decimalFromNullable(x.external.price),
          nav: decimalFromNullable(x.external.nav),
          aum: decimalFromNullable(x.external.aum),
          hedgepnl: decimalFromNullable(x.external.hedgepnl),
          feemngt: decimalFromNullable(x.external.feemngt),
          feeperf: decimalFromNullable(x.external.feeperf),
          otheraccrued: decimalFromNullable(x.external.otheraccrued),
          totalaccrued: decimalFromNullable(x.external.totalaccrued),
          subred: decimalFromNullable(x.external.subred),
          perfdaily: decimalFromNullable(x.external.perfdaily),
          perfweekly: decimalFromNullable(x.external.perfweekly),
          perfmonthly: decimalFromNullable(x.external.perfmonthly),
          perfytd: decimalFromNullable(x.external.perfytd),
          perfstart: decimalFromNullable(x.external.perfstart),
          coefficient: decimalFromNullable(x.external.coefficient),
        }
      : undefined,
    ...
    sharecountPrev: x.sharecount_prev ? unsafeDecimal(x.sharecount_prev) : undefined,
    sharecountCurr: x.sharecount_curr ? unsafeDecimal(x.sharecount_curr) : undefined,
    sharecountDiff: x.sharecount_diff ? unsafeDecimal(x.sharecount_diff) : undefined,
